...
#pragma region "object initialization"
	...
	global::scene.objects["triangle"] = new GLtriangle(triangleVertices, sizeof(triangleVertices) / sizeof(*triangleVertices), GL_STATIC_DRAW);
	global::scene.shaders["object"].setAttribute(global::scene.objects["triangle"]->VAO, "in_coords", 3, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), (GLvoid*)0);
	global::scene.shaders["object"].setAttribute(global::scene.objects["triangle"]->VAO, "in_color", 3, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), (GLvoid*)(3 * sizeof(GLfloat)));
...
#pragma region "game cycle"
	while (!glfwWindowShouldClose(global::window.glfwWindowPointer)) {
	    ...
	    currentShader->enable();
	        ...
	        currentObject = global::scene.objects["triangle"];
